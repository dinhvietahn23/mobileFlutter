...
class FormPage extends StatefulWidget {
  FormPage({Key? key, required this.id, required this.expenses}) : super(key: key);
  final int id;
...
class _FormPageState extends State<FormPage> {
  ...
  void _submit() {
    ...
    if (form!.validate()) {
      form.save();
      expenses.add(Expense(this.id, _amount!, _date!, _category!));
      //expenses.update(Expense(this.id, _amount!, _date!, _category!));
      //expenses.insert(Expense(this.id, _amount!, _date!, _category!));
